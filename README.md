...
Welcome to the Mechanica Binder repository! 
This repository contains the source and supporting 
infrastructure for availability of Mechanica on 
[Binder](https://mybinder.readthedocs.io/en/latest/index.html). 
All source is taken from the 
[Mechanica project repository](https://github.com/tjsego/mechanica). 
